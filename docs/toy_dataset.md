...
| **T2T-CHM13 v2.0** | Reference genome used to align the 1KG ONT Vienna reads — the encoding reference for `*.t2t.cram` files. For new analyses, `--genome chm13v2.0_maskedY_rCRS` is the recommended best practice (chrY PAR hard-masked, rCRS mitochondria). | Nurk *et al.* (2022). The complete sequence of a human genome. *Science* 376, 44–53. [https://doi.org/10.1126/science.abj6987](https://doi.org/10.1126/science.abj6987). Plain: [chm13v2.0.fa.gz](https://s3-us-west-2.amazonaws.com/human-pangenomics/T2T/CHM13/assemblies/analysis_set/chm13v2.0.fa.gz). Best practice: [chm13v2.0_maskedY_rCRS.fa.gz](https://s3-us-west-2.amazonaws.com/human-pangenomics/T2T/CHM13/assemblies/analysis_set/chm13v2.0_maskedY_rCRS.fa.gz) |
...
| T2T-CHM13 v2.0 reference genome | The reference used to encode the CRAM. Download: [chm13v2.0.fa.gz](https://s3-us-west-2.amazonaws.com/human-pangenomics/T2T/CHM13/assemblies/analysis_set/chm13v2.0.fa.gz) — or downloaded automatically via `--genome chm13v2.0`. For new analyses, use `--genome chm13v2.0_maskedY_rCRS` for best practice. |
